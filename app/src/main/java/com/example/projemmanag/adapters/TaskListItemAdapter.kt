        ...
        if (holder is MyViewHolder){
            ...
            val helper=ItemTouchHelper(
                object :ItemTouchHelper.SimpleCallback(
                    ItemTouchHelper.UP or ItemTouchHelper.UP,0
                ){
                    override fun onMove(
                        ...
                        val taretPos=target.adapterPosition
                        if (mPositionDraggedFrom==-1){
                            mPositionDraggedFrom==draggedPosition
                        }
                        mPositionDraggedTo=taretPos
                        Collections.swap(list[position].cards,draggedPosition,taretPos)
                        adapter.notifyItemMoved(draggedPosition,taretPos)
                        return false
                    }
